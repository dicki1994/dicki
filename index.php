		        ...
		        <div class="row">	        		
		            ...
		            <div class="collapse navbar-collapse">
		                <ul class="nav navbar-nav navbar-right">                 
		                    <li class="scroll active"><a href="#home">News</a></li>
		                    <li class="scroll"><a href="#explore">Profil</a></li>                         
		                    <li class="scroll"><a href="#event">Service</a></li>
		                    <li class="scroll"><a href="#about">Gues book</a></li>                     
		                    <li class="no-scroll"><a href="#twitter">Portofolio</a></li>
